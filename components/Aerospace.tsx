...
export default function Aerospace() {
  return (
    <section id="aerospace" className="py-32 px-6 bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-6xl mx-auto">
        {/* Section Header */}
        <div className="text-center mb-16">
          <h2 className="text-5xl font-bold text-foreground mb-4">Aerospace Experience</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          {companies.map((company, index) => (
            <a
              ...
              className="group bg-white border-2 border-gray-200 rounded-2xl p-8 hover:shadow-2xl hover:border-foreground transition-all duration-300"
            >
              {/* Company Logo */}
              <div className="mb-6 flex items-center justify-center bg-gray-50 rounded-xl p-6 h-32">
                <img
                  src={company.logo}
              ...
              <div className="mb-6">
                ...
                <p className="text-sm font-semibold text-gray-500 bg-gray-100 px-4 py-2 rounded-full inline-block">
                  {company.period}
                </p>
              </div>
              ...
              {/* Role */}
              <div className="mb-4">
                <p className="text-xl font-semibold text-gray-700">{company.role}</p>
              </div>
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {company.focus.split(', ').map((item, i) => (
                  <span
                    key={i}
                    className="px-3 py-1 bg-foreground/5 text-foreground text-sm rounded-lg font-medium"
                  >
                    {item}
                  </span>
                ))}
              ...
              {/* Visit Website Link */}
              <div className="flex items-center text-sm font-semibold text-foreground mt-4">
        ...
        <div className="bg-white border-2 border-gray-200 rounded-2xl p-8 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <h4 className="text-xl font-bold text-foreground mb-3">Proprietary Work</h4>
