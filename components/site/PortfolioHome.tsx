  ...
  return (
    <div className={styles.site}>
      ...
      <main id="main-content">
        ...
        <section id="contact" className={styles.contact} aria-labelledby="contact-title"><div className={styles.container}><p className={styles.eyebrow}>04 / A GOOD CONVERSATION IS A START</p><div className={styles.contactHeading}><h2 id="contact-title">What could we<br/><em>build together?</em></h2><a href={email} className={styles.contactArrow} aria-label="Email Andy"><ArrowUpRight aria-hidden="true"/></a></div><div className={styles.contactBottom}><a href={email}>andrewsottiaux@gmail.com</a><p>Interesting problems. Thoughtful people. New possibilities.</p></div></div></section>
      </main>
