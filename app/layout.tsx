  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <link rel="preconnect" href={CAMERA_HOST} crossOrigin="anonymous" />
        <link rel="dns-prefetch" href={CAMERA_HOST} />
        <link rel="preload" as="image" href={SNAPSHOT_URL} />
        <link rel="modulepreload" href={PLAYER_SCRIPT_URL} crossOrigin="anonymous" />
        <script
