...
export const PROJECT_CASE_STUDIES: ProjectCaseStudy[] = [
  {
    ...
    role: 'Runner-focused interface design, Raspberry Pi integration, custom display-driver engineering, data integrations, and reliability testing.',
    ...
    proof: 'A runner-focused interface connected to service integrations, custom display control, and a tested software refresh policy. The software verification record and its limits are documented below.',
    metrics: ['1360 × 480 canvas', 'Four-color interface', 'Two display controllers', '172 hardware-free checks'],
    architecture: [
    ...
    tour: {
      ...
      stops: [
        ...
        },
        {
          ...
          detail: 'Seam-safe partial updates, periodic de-ghosting, offline fallbacks, and configurable powered-down quiet periods keep the display useful without continuous activity.',
          accent: 'black',
        },
      ],
    },
  ...
  },
  {
    ...
    metrics: ['Edge-camera system', 'On-device RKNN', 'Solar telemetry', 'Protected playback'],
  ...
  },
  {
    ...
    built: 'Integrated YOLOv8 perception, ROS2 control plumbing, browser-based WASD control, live video, an ESP32 motor interface, and a visual-servoing controller.',
    ...
    architecture: ['Camera and YOLOv8 perception node', 'Visual-servoing follower with smoothing and velocity feedforward', 'Browser video and WASD command surface', 'I2C bridge to ESP32 motor control'],
    validation: ['Published source reviewed at commit d669b88 on September 4, 2026', 'Firmware includes a command watchdog and motor-stop handler', 'Browser implements WASD, key-release, and focus-loss handling', 'Source inspection is not a measured field trial or safety certification'],
    constraints: [
